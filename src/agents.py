...
class MeetingPrepAgents():
    ...
    def research_agent(self):
        return Agent(
            ...
            backstory=dedent(
                ...
                and entities participating in the meeting. Your insights will lay the groundwork for strategic 
                meeting preparation.
                """
            ),
            verbose=True
    ...
    def meeting_strategy_agent(self):
        return Agent(
            ...
            backstory=dedent(
                """\
                As a Strategy Advisor, your expertise will guide the development of talking points, insightful 
                questions, and strategic angles to ensure the meeting's objectives are achieved.
                """
            ),
            verbose=True
    )
